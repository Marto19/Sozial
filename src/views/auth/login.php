...
<head>
    ...
    <style>
        ...
        .form-container { padding: 20px; border: 1px solid #ddd; border-radius: 5px; margin-top: 20px; }
...
<body>
  ...
  <div class="container">
    ...
    <div class="form-container">      <p class="title">Log in</p>
      <form class="form" method="post" action="/login">
        ...
        <button class="sign" type="submit" name="Login">Log in</button>
      </form>
