<?php
$pageTitle = 'Sign Up - PostJunkyard';
$activePage = 'signup';
?>
...
<body>
  ...
  <div class="container">
    <div class="second-text">Welcome: Connect, Share, Thrive: Where Every Story Finds its Community!</div>
    <div class="form-container">
      ...
      <form class="form" method="post" action="signup.php">
        ...
        <button class="sign" type="submit" name="Sign up">Sign up</button>
      </form>
